   ...
   t: {
      notification: {
         vote: {
            ...
            error: "Error: Vote was not recorded - %{error}",
         },
         file: {
      ...
      input: {
         ...
         refToDonation: "Donation reference",
         budget: "Budget",
      ...
      reset: {
         ...
         description: "A password reset link will be sent to the following email address:",
         input: "Email address",
         cancel: "Cancel",
         send: "Send email",
         sending: "Sending...",
         notFound: "No registered email address found for:",
      ...
      register: {
         ...
         notification: {
            ...
            server: "Server error occurred. User already exists",
         },
      },
      menu: {
         stats: "Statistics",
      ...
      notifications: {
         recordVerified: "Record verified, editing is not allowed",
      },
      chart: {
         pv: "Total donations",
         uv: "Current fund",
