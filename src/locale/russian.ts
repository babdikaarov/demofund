...
const RussianTranslation: TranslationMessages = {
   t: {
      notification: {
         wait: {
            note1: "Доступ к этой платформе предоставляется только после авторизации администратором.",
            note2: "Поскольку вы здесь, это означает, что администратор уведомил вас посетить эту платформу. Пожалуйста, уведомьте администратора о вашей регистрации, чтобы он мог вас авторизовать.",
         },
         vote: {
